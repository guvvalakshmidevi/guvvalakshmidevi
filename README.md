...
A clean and responsive portfolio website built with **HTML, CSS & JavaScript**.
...
An AI-powered learning project designed to help users **scan, learn, and improve English**.
